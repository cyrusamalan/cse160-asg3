...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let s = 0;
        for (let i = 0; i < 3; i += 1) {
          s += other1.elements[i] * other2.elements[i];
        }
    ...
    static cross(other1, other2) {
        ...
        let c = [0, 0, 0];
        c[0] = (other1.elements[1]*other2.elements[2]) - (other1.elements[2]*other2.elements[1]);
        c[1] = (other1.elements[2]*other2.elements[0]) - (other1.elements[0]*other2.elements[2]);
        c[2] = (other1.elements[0]*other2.elements[1]) - (other1.elements[1]*other2.elements[0]);
        let v3 = new Vector3(c); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        ...
        const m = s**0.5; // Modify this line to calculate this vector's magnitude.
